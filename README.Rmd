...
## Contributions
The functions were contributed by Jahin Kabir, with help from the packages cited below. Minimal help was used from GenAI, with the `binnedByDistancePlot()` function, to get help with binning the mutations by distance.
